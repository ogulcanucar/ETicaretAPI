...
using ETicaretAPI.Application.Features.Queries.Role.GetRolesById;
using MediatR;
...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(ActionType =ActionType.Reading,Definition ="Get Roles",Menu =AuthorizeDefinitionConsts.AuthorizeService)]
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Reading, Definition = "Get Role By Id", Menu = AuthorizeDefinitionConsts.AuthorizeService)]
        ...
        [HttpPost()]
        [AuthorizeDefinition(ActionType = ActionType.Writing, Definition = "Create Role", Menu = AuthorizeDefinitionConsts.AuthorizeService)]
        ...
        [HttpPut("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Updating, Definition = "Update Role", Menu = AuthorizeDefinitionConsts.AuthorizeService)]
        ...
        [HttpDelete("{Id}")]
        [AuthorizeDefinition(ActionType = ActionType.Deleting, Definition = "Delete Role", Menu = AuthorizeDefinitionConsts.AuthorizeService)]

...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpPost]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Orders, ActionType = ActionType.Writing, Definition = "Create Order")]
        public async Task<IActionResult> CreateOrder(CreateOrderCommandsRequest createOrderCommandsRequest)
        {
            CreateOrderCommandsResponse response = await _mediator.Send(createOrderCommandsRequest);
            return Ok(response);
        }
        [HttpGet("{Id}")]
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Orders, ActionType = ActionType.Updating, Definition = "Complete Order")]
